...
//       hPLID: breakConDetailData.hPLID ?? 0,
//       bCDID: breakConDetailData.bCDID || 0,
//       bLID: breakConDetailData.bLID || 0,
//       rActiveYN: breakConDetailData.rActiveYN, // Preserving the existing value for rActiveYN
//       rCreatedID: breakConDetailData.rCreatedID || 0,
//       rCreatedBy: breakConDetailData.rCreatedBy || "",
//       rCreatedOn: new Date(breakConDetailData?.rCreatedOn || new Date()),// Ensure correct date format
//       rModifiedID: breakConDetailData.rModifiedID || 0,
//       rModifiedBy: breakConDetailData.rModifiedBy || "",
//       rModifiedOn: new Date(breakConDetailData?.rModifiedOn || new Date()), // Ensure correct date format
...
//     try {
//       // Adjust the data based on isPhyResYN
//       const updatedBreakListData = {
//         ...breakListData,
//         rActiveYN: breakListData.isPhyResYN === "Y" ? "N" : "Y" // Reverse logic
//       };

//       // Save the break list data
//       const breakListResponse = await BreakListService.saveBreakList(token!, updatedBreakListData);

//       if (breakListResponse.success) {
//         notifySuccess('Break List saved successfully');

//         // Prepare the payload for BreakConDetail
//         const breakConDetailData: BreakConDetailData = {
//           hPLID: updatedBreakListData.isPhyResYN === "N"
...
//           rActiveYN: updatedBreakListData.rActiveYN || "N",
//           rCreatedID: updatedBreakListData?.rCreatedID || 0,
//           rCreatedBy: updatedBreakListData?.rCreatedBy || "",
//           rCreatedOn: new Date(updatedBreakListData?.rCreatedOn || new Date()),
//           rModifiedID: updatedBreakListData?.rCreatedID || 0,
//           rModifiedBy: updatedBreakListData?.rModifiedBy || "",
//           rModifiedOn: new Date(updatedBreakListData?.rModifiedOn || new Date()),
//           rNotes: updatedBreakListData?.rNotes || "",
//           compID: updatedBreakListData?.compID || 0,
//           compCode: updatedBreakListData?.compCode || "",
//           compName: updatedBreakListData?.compName || "",
//           transferYN: updatedBreakListData?.transferYN || "N",
//         };

//         // Save the break condition detail
...
//       ...prevState,
//       isPhyResYN: value === "Y" ? "N" : "Y", // Reverse logic
//       rActiveYN: value === "Y" ? "N" : "Y"   // Reverse logic
//     }));
//   };
...
//               <RadioGroup
//                 row
//                 value={breakListData.isPhyResYN === "Y" ? "N" : "Y"} // Reverse logic
//                 onChange={handleRadioChange}
//               >
//                 <FormControlLabel
//                   value="N"  // Value for Resources (selected when isPhyResYN is "Y")
//                   control={<Radio />}
//                   label="Resources"
//                 />
//                 <FormControlLabel
//                   value="Y"  // Value for Physicians (selected when isPhyResYN is "N")
//                   control={<Radio />}
//                   label="Physicians"
//                 />
//               </RadioGroup>
