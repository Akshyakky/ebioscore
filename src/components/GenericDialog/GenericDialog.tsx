...
import { Dialog, DialogTitle, DialogContent, DialogActions, IconButton, Typography, Box, SxProps, useTheme, useMediaQuery } from "@mui/material";
...
const StyledDialogTitle = styled(DialogTitle)(({ theme }) => ({
  ...
  backgroundColor: theme.palette.mode === "dark" ? theme.palette.background.paper : theme.palette.primary.main, // Blue color in light mode
  color: theme.palette.mode === "dark" ? theme.palette.text.primary : theme.palette.primary.contrastText, // Contrasting text color for light mode
}));
