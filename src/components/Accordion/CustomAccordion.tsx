...
import { Accordion, AccordionSummary, AccordionDetails, Typography, styled, Theme, alpha, useTheme } from "@mui/material";
...
const CustomAccordion: React.FC<CustomAccordionProps> = ({ title, children, defaultExpanded = false }) => {
  ...
  return (
    <StyledAccordion defaultExpanded={defaultExpanded}>
      <StyledAccordionSummary expandIcon={<ExpandIcon />} aria-controls={`${title}-content`} id={`${title}-header`}>
