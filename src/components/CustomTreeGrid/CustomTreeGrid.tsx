...
const CustomTreeGrid = <T extends Record<string, any>>({
    columns,
    data,
    maxHeight = '500px',
    minHeight,
    ...
    const sortedData = useMemo(() => {
        ...
        return [...data].sort((a, b) => {
            if (orderBy === 'siNo') {
                return order === 'asc'
                    ? Number(a[orderBy as keyof T]) - Number(b[orderBy as keyof T])
                    : Number(b[orderBy as keyof T]) - Number(a[orderBy as keyof T]);
            }
