...
const AlertPopUp: React.FC<AlertPopUpProps> = ({ open, onClose, alertData }) => {
  ...
  return (
    <GenericDialog
      ...
      maxWidth="md"
      fullWidth
      actions={<CustomButton onClick={onClose} color="secondary" text="Close" variant="contained" icon={Close} />}
    >
      <CustomGrid columns={defaultColumns} data={activeAlerts} maxHeight="400px" minHeight="300px" />
    </GenericDialog>
  );
};
