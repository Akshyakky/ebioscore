...
export const getActiveWorkingUsers = async (): Promise<OperationResult<UserListData[]>> => {
  return apiService.get<OperationResult<UserListData[]>>("User/GetActiveWorkingUsers", getToken());
};

export const getAllUsers = async (): Promise<OperationResult<UserListData[]>> => {
  return apiService.get<OperationResult<UserListData[]>>("User/GetAllUsers", getToken());
};

export const saveUser = async (userData: UserListData): Promise<OperationResult<UserListData>> => {
...
export const updateUserActiveStatus = async (appID: number, isActive: boolean): Promise<OperationResult<any>> => {
  return apiService.post<OperationResult<any>>(`User/UpdateUserActiveStatus/${appID}`, isActive, getToken());
};
