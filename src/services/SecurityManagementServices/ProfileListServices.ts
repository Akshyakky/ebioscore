...
export const saveOrUpdateProfile = async (
  ...
  return apiService.post<OperationResult<ProfileMastDto>>(
...
export const saveOrUpdateProfileDetail = async (
  ...
  return apiService.post<OperationResult<ProfileDetailDto>>(
    "Profile/SaveOrUpdateProfileDetail",
    profileDetailDto,
    getToken()
  );
};

export const getAllProfileDetails = async (): Promise<
  OperationResult<ProfileListSearchResult[]>
> => {
  return apiService.get<OperationResult<ProfileListSearchResult[]>>(
    "Profile/GetAllProfileDetails",
    getToken()
  );
};
...
export const getProfileModuleOperations = async (
  ...
  return apiService.get<OperationResult<ModuleOperation[]>>(
    "SecurityManagement/GetProfileModuleOperations",
    getToken(),
    { subID, compID, profileID }
  );
};
...
export const getProfileReportOperations = async (
  ...
  return apiService.get<OperationResult<ReportPermission[]>>(
    "SecurityManagement/GetProfileReportOperations",
    getToken(),
    { subID, compID, profileID }
  );
};
