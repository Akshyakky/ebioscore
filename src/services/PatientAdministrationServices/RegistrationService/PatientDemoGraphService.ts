...
export const getPatientDemographicsByPChartID = async (
  ...
  return apiService.get<OperationResult<PatientDemoGraph>>(
    `PatientDemoGraph/GetPatientDemographics/${pChartID}`,
    getToken()
  );
};
...
export const savePatientDemographics = async (
  ...
  return apiService.post<OperationResult<boolean>>(
    "PatientDemoGraph/SavePatientDemographics",
    patientDetails,
    getToken()
  );
};
