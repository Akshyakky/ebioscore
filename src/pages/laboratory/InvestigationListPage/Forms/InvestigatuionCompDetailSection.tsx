                  ...
                  >
                    ...
                    {component.multipleChoices?.length > 0 && (
                      <Box sx={{ mt: 2 }}>
                        ...
                        {component.multipleChoices.map((mc: LCompMultipleDto, idx: number) => (
                    ...
                    {component.ageRanges?.length > 0 && (
                      <Box sx={{ mt: 2 }}>
                        ...
                        {component.ageRanges.map((ar: LCompAgeRangeDto, idx: number) => (
                          <Typography key={idx} variant="body2">
                    ...
                    {component.templates?.length > 0 && (
                      <Box sx={{ mt: 2 }}>
                        ...
                        {component.templates.map((tp: LCompTemplateDto, idx: number) => (
                          <Typography key={idx} variant="body2">
                            - {tp.tGroupName}
                          </Typography>
                        ))}
            ...
            <Paper sx={{ p: 3, borderRadius: 3, minHeight: "60vh" }}>
              {selectedComponent ? (
                <>
                  ...
                  {selectedComponent.lCentID === 5 && selectedComponent.multipleChoices?.length > 0 && (
                    <Box sx={{ mt: 3 }}>
                      <Typography variant="h6">Multiple Choice Values</Typography>
                      {selectedComponent.multipleChoices.map((choice: LCompMultipleDto, idx: number) => (
                  ...
                  {selectedComponent.lCentID === 6 && selectedComponent.ageRanges?.length > 0 && (
                    <Box sx={{ mt: 3 }}>
                  ...
                  {selectedComponent.lCentID === 7 && selectedComponent.templates?.length > 0 && (
                    <Box sx={{ mt: 3 }}>
