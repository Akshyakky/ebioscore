...
const ProductOverviewDetail: React.FC<ProductOverviewDetailProps> = ({
    ...
    const columns: Column<ProductListDto>[] = [
        ...
        { key: "manufacturerGenericName", header: "Generic Name", visible: true },
        {
            ...
            render: (rowData: ProductListDto) => (
                <Typography variant="body2">
                    {rowData.rActiveYN === "Y" ? "Active" : "Hidden"}
                </Typography>
            ),
        },
        { key: "pLocationName", header: "Product Location", visible: true },
        {
            ...
            render: (rowData: ProductListDto) => (
                <CustomButton
                    onClick={() => handleEdit(rowData.productID)}
                    text="Enter Result"
                    icon={AddIcon}
                    variant="contained"
                    size="small"
    ...
    return (
        <Paper variant="elevation" sx={{ padding: 2 }}>
            ...
            >
                <Grid item xs={12} md={3}>
                    <FormField
                        ...
                        suggestions={productOptions.map(
            ...
            <Grid container spacing={2}>
                {Array.isArray(selectedProductData) &&
            ...
            >
                <Grid container spacing={2}>
                    ...
                    <FormField
                        type="text"
                        label="Rack"
                        value={formState.rackNo}
                        onChange={handleInputChange}
                        ControlID="dialogRack"
                        name="rackNo"
                        placeholder="Rack"
                    />
                    <FormField
                        type="text"
                        label="Shelf"
                        value={formState.shelfNo}
                        onChange={handleInputChange}
                        ControlID="dialogShelf"
                        name="shelfNo"
                        placeholder="Shelf"
                    />
                    <FormField
