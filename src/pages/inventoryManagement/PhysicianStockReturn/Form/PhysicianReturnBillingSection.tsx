...
const PhysicianReturnBillingSection: React.FC<BillingSectionProps> = ({ control }) => {
  ...
  const physicianName = useWatch({ control, name: "physicianName" });
  ...
  const getReturnTypeTitle = () => {
    switch (returnTypeCode) {
      case PhysicianReturnType.Physician:
        return "Physician Return Summary";
      case PhysicianReturnType.InventoryAdjustment:
        return "Inventory Adjustment Summary";
      default:
        return "Physician Return Summary";
    }
  };
  ...
  return (
    <Paper elevation={1} sx={{ p: 2, mb: 3 }}>
      <Typography variant="h6" gutterBottom sx={{ display: "flex", alignItems: "center", gap: 1, mb: 3 }}>
        ...
        <Chip label={`Department: ${fromDeptName || "Not Selected"}`} size="small" color="secondary" variant="outlined" />
        {physicianName && <Chip label={`Physician: ${physicianName}`} size="small" color="success" variant="outlined" />}
      </Typography>
      ...
      >
        ...
        <Box sx={{ textAlign: "right" }}>
          ...
          <Typography variant="h6" color="warning.main" sx={{ fontWeight: 600 }}>
            {returnTypeCode === PhysicianReturnType.Physician ? "Physician Return" : "Inventory Adjustment"}
          </Typography>
        </Box>
      </Box>
      ...
      <Alert severity="info" sx={{ mt: 2 }}>
        <Typography variant="body2">
          ...
          {returnTypeCode === PhysicianReturnType.Physician
            ? `This return will adjust inventory issued to ${physicianName || "the physician"}. Stock will be returned to ${fromDeptName || "department"} upon approval.`
            : "This is an inventory adjustment for physician-assigned items. Stock levels will be adjusted upon approval."}
        </Typography>
      </Alert>
    </Paper>
  );
...
export default PhysicianReturnBillingSection;
