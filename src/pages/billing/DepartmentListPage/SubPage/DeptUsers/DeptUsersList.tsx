...
const DeptUsersList: React.FC<DeptUsersListProps> = ({ deptUsers, handleSwitchChange }) => {
  return (
    <Table>
      <TableHead>
        <TableRow>
          ...
          <TableRow key={user.deptUserID}>
            ...
            <TableCell>
              <FormField
                ...
                onChange={(e) => handleSwitchChange(user.deptUserID, "allowPMYN", e.target.checked)}
                name="allowPM"
                ControlID={`allowPM_${user.deptUserID}`}
              />
            </TableCell>
            <TableCell>{user.rActiveYN === "Y" ? "Active" : "Hidden"}</TableCell>
            <TableCell>
              <FormField
                type="switch"
                label=""
                ...
                onChange={(e) => handleSwitchChange(user.deptUserID, "rActiveYN", e.target.checked)}
                name="rActive"
